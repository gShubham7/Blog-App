...
export default function Blog() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${process.env.REACT_APP_BASE_URL}/user/post/${id}`)
      .then((res) => {
  ...
  const handleLike = (id) => {
    if (loggedIn) {
      if (!liked) {
        axios
          .post(`${process.env.REACT_APP_BASE_URL}/user/post/like/${id}`, {
            user_id: userId,
          })
          .then((res) => {
            setBlog(res.data.blog);
        ...
        axios
          .post(
            `${process.env.REACT_APP_BASE_URL}/user/post/unlike/${id}`,
            {
              user_id: userId,
            }
          )
  ...
  const addComment = (id) => {
    axios
      .post(`${process.env.REACT_APP_BASE_URL}/user/post/comment/${id}`, {
        user_id: userId,
